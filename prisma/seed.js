...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var password1, password2, user1, user2, project1, project2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bcryptjs_1.default.hash("password123", 10)];
                case 1:
                    password1 = _a.sent();
                    return [4 /*yield*/, bcryptjs_1.default.hash("secure456", 10)];
                case 2:
                    password2 = _a.sent();
                ...
                case 5:
                    ...
                    return [4 /*yield*/, prisma.project.create({
                            data: {
                                ...
                                description: "Develop final year college project",
                                status: "completed",
                                userId: user2.id,
                            },
                        })];
                            ...
                            data: [
                                {
                                    ...
                                    description: "Design the UI for homepage",
                                    status: "todo",
                                    dueDate: new Date(),
                                ...
                                },
                                {
                                    ...
                                    description: "Document the final year project",
                                    status: "done",
                                    dueDate: new Date(),
